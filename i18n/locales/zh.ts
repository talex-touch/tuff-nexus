  ...
  dashboard: {
    ...
    sections: {
      ...
      menu: {
        ...
        images: '素材',
        betaHeading: '预览节奏',
        betaDescription: '扩展与团队功能正持续迭代，右侧面板会展示当前可用的模块。',
      },
      plugins: {
        title: '扩展与插件',
        ...
        manageTitle: '插件管理',
        manageSubtitle: '快速发布新集成或在上线前调整条目。',
        addButton: '新建插件',
        closeButton: '收起',
        ...
        previewLoading: '正在读取压缩包中的 README…',
      ...
      images: {
        title: '素材库',
        subtitle: '管理仪表盘插件与更新会用到的共享图片资源。',
        uploadTitle: '上传图片',
        uploadSubtitle: '支持 PNG、JPEG、WebP、GIF 或 SVG，大小不超过 5 MB。',
        selectFile: '选择图片文件',
        uploading: '正在上传…',
        loading: '正在加载图片…',
        empty: '目前还没有上传的图片。',
