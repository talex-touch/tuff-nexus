export const PLUGIN_CATEGORIES = [
  ...
  { id: 'utilities', icon: 'i-carbon-tools-alt', i18nKey: 'plugins.categories.utilities' },
  ...
  { id: 'ai', icon: 'i-carbon-ai-status', i18nKey: 'plugins.categories.ai' },
  { id: 'automation', icon: 'i-carbon-automation', i18nKey: 'plugins.categories.automation' },
