...
<template>
  <div class="relative search">
    <span class="absolute left-4 top-1/2 -translate-y-1/2 text-primary/40 dark:text-light/50 pointer-events-none">
    ...
    <input
      ...
      placeholder="Search..."
      aria-label="Search"
      class="w-full rounded-2xl border border-transparent bg-primary/5 py-2.5 pl-10 pr-4 text-sm text-primary/80 outline-none transition focus:border-primary/30 focus:bg-white/90 focus:text-primary focus:shadow-[0_8px_24px_rgba(24,24,28,0.12)] focus:ring-0 dark:bg-light/5 dark:text-light/80 dark:focus:border-light/30 dark:focus:bg-primary/80 dark:focus:text-light"
    />
    <ul
    ...
    >
      ...
      >
        <NuxtLink
          :to="result._path"
          class="block px-4 py-2 text-sm text-primary/70 transition hover:bg-primary/5 hover:text-primary dark:text-light/80 dark:hover:bg-light/10 dark:hover:text-light"
        >
          {{ result.title }}
        </NuxtLink>
      </li>
