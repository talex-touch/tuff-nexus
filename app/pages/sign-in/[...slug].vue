  ...
  <div class="relative min-h-screen flex items-center justify-center bg-white px-4 py-16 dark:bg-gray-900">
    <div class="max-w-md w-full">
      ...
      <div
        ...
        class="space-y-6"
      >
        <div class="border-box max-w-[400px] border border-primary/15 rounded-2xl bg-primary/5 px-4 py-3 text-sm text-primary/80 dark:border-light/20 dark:bg-light/10 dark:text-light/80">
