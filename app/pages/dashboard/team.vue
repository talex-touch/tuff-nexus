          ...
          <div class="rounded-2xl border border-primary/10 bg-white/70 p-4 dark:border-light/10 dark:bg-primary/60">
            ...
            <ul class="mt-4 space-y-3">
              ...
              >
                ...
                <span class="inline-flex items-center rounded-full bg-primary/10 px-3 py-1 text-[11px] font-semibold uppercase tracking-wide text-primary/80 dark:bg-light/10 dark:text-light/80">
